...
var binDir = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.Web/bin/"));
var webPackageDir = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.Web/obj/Debug/Package/ApiApi.Web.zip"));
var projectFile = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.Web/ApiApi.Web.csproj"));
var solutionFile = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.sln"));
var buildDir = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.Web/bin/") + Directory(configuration));
var publishDir = System.IO.Path.GetFullPath(Directory("./Src/ApiApi.Web/obj/Debug/Package/PackageTmp/")) + System.IO.Path.DirectorySeparatorChar;
...
Task("UpdateVersionFiles")
  ...
  .Does(() =>
{
	var WebApiAssemblyFileName = thisDir + @"Src\ApiApi.Web\Properties\AssemblyInfo.cs";
